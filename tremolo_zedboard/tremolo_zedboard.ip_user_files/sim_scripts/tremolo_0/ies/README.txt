...
#
# Generated by export_simulation on Sun Aug 28 14:06:31 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './tremolo_0.sh' script.

./tremolo_0.sh -reset_run
...
./tremolo_0.sh -noclean_files

For more information on the script, please type './tremolo_0.sh -help'.
