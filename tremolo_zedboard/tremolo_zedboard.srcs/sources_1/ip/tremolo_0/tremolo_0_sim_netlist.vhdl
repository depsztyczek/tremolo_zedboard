...
entity tremolo_0_tremolo is
  port (
    ...
    angle_out : out STD_LOGIC_VECTOR ( 26 downto 0 );
    rst : in STD_LOGIC;
    clk : in STD_LOGIC;
...
architecture STRUCTURE of tremolo_0_tremolo is
  ...
  signal \^angle_out\ : STD_LOGIC_VECTOR ( 26 downto 0 );
  ...
  signal \angle_out[30]_i_10_n_0\ : STD_LOGIC;
  signal \angle_out[30]_i_11_n_0\ : STD_LOGIC;
  signal \angle_out[30]_i_1_n_0\ : STD_LOGIC;
  signal \angle_out[30]_i_2_n_0\ : STD_LOGIC;
  signal \angle_out[30]_i_3_n_0\ : STD_LOGIC;
  signal \angle_out[30]_i_4_n_0\ : STD_LOGIC;
  signal \angle_out[30]_i_5_n_0\ : STD_LOGIC;
  signal \angle_out[30]_i_6_n_0\ : STD_LOGIC;
  signal \angle_out[30]_i_7_n_0\ : STD_LOGIC;
  signal \angle_out[30]_i_8_n_0\ : STD_LOGIC;
  signal \angle_out[30]_i_9_n_0\ : STD_LOGIC;
  ...
  signal angle_out_nxt0 : STD_LOGIC_VECTOR ( 30 downto 4 );
  ...
  signal \right_ch_temp0__1\ : STD_LOGIC_VECTOR ( 23 downto 1 );
  ...
  signal \NLW_angle_out_nxt0_carry__5_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_angle_out_nxt0_carry__5_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  signal \NLW_left_ch_temp1_carry__4_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_left_ch_temp1_carry__4_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state_nxt_reg[0]_i_1\ : label is "soft_lutpair1";
  attribute XILINX_LEGACY_PRIM of \FSM_onehot_state_nxt_reg[1]\ : label is "LD";
  attribute SOFT_HLUTNM of \FSM_onehot_state_nxt_reg[1]_i_1\ : label is "soft_lutpair2";
  attribute XILINX_LEGACY_PRIM of \FSM_onehot_state_nxt_reg[2]\ : label is "LD";
  attribute SOFT_HLUTNM of \FSM_onehot_state_nxt_reg[2]_i_1\ : label is "soft_lutpair1";
  ...
  attribute METHODOLOGY_DRC_VIOS of \__0\ : label is "{SYNTH-10 {cell *THIS*} {string 18x23 4}}";
  attribute METHODOLOGY_DRC_VIOS of \__1\ : label is "{SYNTH-10 {cell *THIS*} {string 18x23 4}}";
  attribute SOFT_HLUTNM of \angle_out[30]_i_4\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \left_ch_temp_reg[36]_i_1\ : label is "soft_lutpair7";
  attribute XILINX_LEGACY_PRIM of \left_ch_temp_reg[37]\ : label is "LD";
  attribute SOFT_HLUTNM of \left_ch_temp_reg[37]_i_1\ : label is "soft_lutpair8";
  attribute XILINX_LEGACY_PRIM of \left_ch_temp_reg[38]\ : label is "LD";
  attribute SOFT_HLUTNM of \left_ch_temp_reg[38]_i_1\ : label is "soft_lutpair6";
  attribute XILINX_LEGACY_PRIM of \left_ch_temp_reg[39]\ : label is "LD";
  attribute SOFT_HLUTNM of \left_ch_temp_reg[39]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \left_ch_temp_reg[42]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \left_ch_temp_reg[44]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \quarter_nxt_reg[0]_i_1\ : label is "soft_lutpair0";
  attribute XILINX_LEGACY_PRIM of \quarter_nxt_reg[1]\ : label is "LD";
  attribute SOFT_HLUTNM of \quarter_nxt_reg[1]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \right_ch_temp_reg[44]_i_1\ : label is "soft_lutpair16";
  attribute XILINX_LEGACY_PRIM of \right_ch_temp_reg[45]\ : label is "LD";
  attribute SOFT_HLUTNM of \right_ch_temp_reg[45]_i_1\ : label is "soft_lutpair15";
...
begin
  B(0) <= \^b\(0);
  angle_out(26 downto 0) <= \^angle_out\(26 downto 0);
...
\__0\: unisim.vcomponents.DSP48E1
    generic map(
      ...
      USE_SIMD => "ONE48"
        ...
        port map (
      A(29 downto 0) => B"000000001100110011001100110011",
...
\angle_out[30]_i_10\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFEAAAAA"
    )
        port map (
...
\angle_out[30]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\angle_out[30]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\angle_out[30]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"000D"
    )
        port map (
...
\angle_out[30]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\angle_out[30]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\angle_out[30]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000ABBBBBBB"
    )
        port map (
...
\angle_out[30]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\angle_out[30]_i_9\: unisim.vcomponents.LUT6
    generic map(
...
angle_out_nxt0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 2) => \^angle_out\(3 downto 2),
      S(1) => angle_out_nxt0_carry_i_1_n_0,
      S(0) => \^angle_out\(0)
    );
\angle_out_nxt0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \^angle_out\(7),
      S(2) => \angle_out_nxt0_carry__0_i_1_n_0\,
      S(1 downto 0) => \^angle_out\(5 downto 4)
    );
\angle_out_nxt0_carry__0_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\angle_out_nxt0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(2 downto 1) => \^angle_out\(10 downto 9),
      S(0) => \angle_out_nxt0_carry__1_i_2_n_0\
    );
\angle_out_nxt0_carry__1_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\angle_out_nxt0_carry__1_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\angle_out_nxt0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(2 downto 0) => \^angle_out\(14 downto 12)
    );
\angle_out_nxt0_carry__2_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\angle_out_nxt0_carry__5\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_angle_out_nxt0_carry__5_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \angle_out_nxt0_carry__5_n_2\,
      CO(0) => \angle_out_nxt0_carry__5_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_angle_out_nxt0_carry__5_O_UNCONNECTED\(3),
      O(2 downto 0) => angle_out_nxt0(30 downto 28),
      S(3) => '0',
      S(2 downto 0) => \^angle_out\(26 downto 24)
    );
angle_out_nxt0_carry_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
left_ch_temp0: unisim.vcomponents.DSP48E1
    generic map(
      ...
      ALUMODE(3 downto 0) => B"0000",
      B(17) => '0',
      B(16 downto 1) => \right_ch_temp0__1\(16 downto 1),
      B(0) => \__1_n_92\,
      BCIN(17 downto 0) => B"000000000000000000",
...
left_ch_temp1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => \__1_n_90\,
      DI(0) => '0',
      O(3 downto 0) => \right_ch_temp0__1\(4 downto 1),
      S(3) => p_0_in(4),
      S(2) => left_ch_temp1_carry_i_1_n_0,
...
\left_ch_temp1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(0) => '0',
      O(3 downto 0) => \right_ch_temp0__1\(8 downto 5),
      S(3) => p_0_in(8),
      S(2) => \left_ch_temp1_carry__0_i_1_n_0\,
      S(1) => \left_ch_temp1_carry__0_i_2_n_0\,
      S(0) => p_0_in(5)
    );
...
\left_ch_temp1_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 1) => p_0_in(11 downto 10),
      DI(0) => '0',
      O(3 downto 0) => \right_ch_temp0__1\(12 downto 9),
      S(3) => p_0_in(12),
      S(2) => \left_ch_temp1_carry__1_i_1_n_0\,
      S(1) => \left_ch_temp1_carry__1_i_2_n_0\,
      S(0) => p_0_in(9)
    );
...
\left_ch_temp1_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 1) => p_0_in(15 downto 14),
      DI(0) => '0',
      O(3 downto 0) => \right_ch_temp0__1\(16 downto 13),
      S(3) => p_0_in(16),
      S(2) => \left_ch_temp1_carry__2_i_1_n_0\,
      S(1) => \left_ch_temp1_carry__2_i_2_n_0\,
      S(0) => p_0_in(13)
    );
...
\left_ch_temp1_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 1) => p_0_in(19 downto 18),
      DI(0) => '0',
      O(3 downto 0) => \right_ch_temp0__1\(20 downto 17),
      S(3) => p_0_in(20),
      S(2) => \left_ch_temp1_carry__3_i_1_n_0\,
...
\left_ch_temp1_carry__4\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_left_ch_temp1_carry__4_CO_UNCONNECTED\(3 downto 2),
      ...
      DI(1) => p_0_in(22),
      DI(0) => '0',
      O(3) => \NLW_left_ch_temp1_carry__4_O_UNCONNECTED\(3),
      O(2 downto 0) => \right_ch_temp0__1\(23 downto 21),
      S(3) => '0',
      S(2) => p_0_in(23),
      S(1) => \left_ch_temp1_carry__4_i_1_n_0\,
      S(0) => p_0_in(21)
    );
...
\quarter_nxt_reg[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9AAA"
    )
        port map (
...
\quarter_nxt_reg[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AA6AAAAA"
    )
        port map (
...
architecture STRUCTURE of tremolo_0 is
  ...
  signal \^angle_out\ : STD_LOGIC_VECTOR ( 30 downto 4 );
...
begin
  angle_out(31) <= \<const0>\;
  angle_out(30 downto 4) <= \^angle_out\(30 downto 4);
  angle_out(3) <= \<const0>\;
  angle_out(2) <= \<const0>\;
  angle_out(1) <= \<const0>\;
  angle_out(0) <= \<const0>\;
...
inst: entity work.tremolo_0_tremolo
     port map (
      ...
      P(1) => \inst/_n_104\,
      P(0) => \inst/_n_105\,
      angle_out(26 downto 0) => \^angle_out\(30 downto 4),
      clk => clk,
