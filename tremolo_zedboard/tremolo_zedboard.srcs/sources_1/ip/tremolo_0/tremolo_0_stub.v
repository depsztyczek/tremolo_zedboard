...
module tremolo_0(clk, rst, en, input_data_valid, input_sin_valid, 
  left_in, right_in, sin_in, cos_in, left_out, right_out, output_data_valid, angle_out, 
  output_angle_valid)
/* synthesis syn_black_box black_box_pad_pin="clk,rst,en,input_data_valid,input_sin_valid,left_in[23:0],right_in[23:0],sin_in[31:0],cos_in[31:0],left_out[23:0],right_out[23:0],output_data_valid,angle_out[31:0],output_angle_valid" */;
  input clk;
  input rst;
  input en;
